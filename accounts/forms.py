...
from accounts.models import Account, Profile, vedio, TutionClassDetails, Subject
...
class ProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ['gender', 'marital_status', 'category', 'blood_groups',
                  'first_name', 'last_name', 'bio', 'profile_pic']


class TutionClassForm(forms.ModelForm):

    class Meta:
        model = TutionClassDetails
        fields = [
            'tution_class',
            'teacher_address',
            'tutoring_style',
...
class VedioForm(forms.ModelForm):
